...
// country fee
if (comparecsn ($config['site_country'], $user['ship_country'])) $rate = $fee['country'];

// state fee
if (comparecsn ($config['site_country'], $user['ship_country']) &&
   comparecsn ($config['site_state'], $user['ship_state'])) $rate = $fee['state'];

// city fee
if (comparecsn ($config['site_country'], $user['ship_country']) &&
   comparecsn ($config['site_state'], $user['ship_state']) &&
   comparecsn ($config['site_city'], $user['ship_city'])) $rate = $fee['city'];
