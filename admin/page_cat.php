...
while ($row = sql_fetch_array ($res)) { $group_def[$row['group_id']] = $row['group_title']; $page_folder[$row['group_id']] = $row['page_folder']; }
...
if (!empty ($gid))
	$qadmin_cfg['permalink_folder'] = $page_folder[$gid];				// script name for permalink
else
