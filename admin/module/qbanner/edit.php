...
// page_id :: int :: 10
$qadmin_def['page_id']['title'] = 'Banner ID';
...
$qadmin_def['page_image']['title'] = 'Banner Image';
...
$qadmin_def['group_id']['value'] = 'QBANR';
...
$qadmin_def['page_body']['value'] = 'This page is part of qBanner module. Please use qBanner Manager to edit this page.';
...
$qadmin_cfg['action'] = 'task.php?mod=qbanner&run=edit.php';
...
$qadmin_cfg['search_filterby'] = 'group_id=\'QBANR\'';	// filter by sql_query (use , to separate queries) *
$qadmin_cfg['search_filtermask'] = 'qBanner Items';				// mask filter *
...
// form title
$qadmin_title['new'] = 'Add Banner';
$qadmin_title['update'] = 'Update Banner';
$qadmin_title['search'] = 'Search Banner';
$qadmin_title['list'] = 'Banner List';
