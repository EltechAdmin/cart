...
if (!$config['cart']['allow_xpress']) msg_die (sprintf ($lang['msg']['internal_error'], 'Express checkout is not enabled.'));
...
// visual confirmation
// $x = qvc_value();
if (empty ($visual) || qhash (strtolower ($visual)) != qvc_value()) $err[] = $lang['l_captcha_error'];
